...
/**
 * VietnamWorks Platform Response Validator
 * @author nich (@nichxbt)
 * @license Apache-2.0
 */
...
export class VietnamWorksPlatformResponseValidator extends AbstractPlatformResponseValidator {
  /** @type {string} */
  ...
  isValidPayload(response) {
    ...
    if (data && typeof data === 'object') {
      if (Array.isArray(data.data) || Array.isArray(data.items) || data.jobId != null || data.jobTitle != null) {
        return true;
      }
      if (data.meta != null || data.totalHits != null) {
        return true;
      }
    }
