...
export class FacebookCrawler extends AbstractCrawler {
  ...
  constructor(deps = {}) {
    ...
    this.registerAction({
      ...
      description: 'Warm up Facebook session by scrolling feed with human pacing',
      requiredArgs: [],
      optionalArgs: ['targetUrl', 'durationSeconds', 'dryRun'],
      example: { targetUrl: 'https://www.facebook.com', durationSeconds: 60 },
      outputType: '{ dryRun: boolean, platform: "facebook", preview?: any }',
      requiresAuth: true,
    ...
    this.registerAction({
      ...
      description: 'Warm up Facebook account by scrolling feed with optional reactions',
      requiredArgs: [],
      optionalArgs: ['durationSeconds', 'allowReactions', 'reactProbability', 'dryRun'],
      example: { durationSeconds: 120, allowReactions: true },
      outputType: '{ dryRun: boolean, platform: "facebook", preview?: any }',
      requiresAuth: true,
    ...
    this.registerAction({
      ...
      description: 'Cancel outgoing pending Facebook friend requests',
      requiredArgs: [],
      optionalArgs: ['limit', 'olderThanDays', 'dryRun'],
      example: { limit: 10, olderThanDays: 7 },
      outputType: '{ dryRun: boolean, platform: "facebook" }',
      requiresAuth: true,
