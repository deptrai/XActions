 ...
 * @property {Function} [xRange]
 * @property {Function} [xrange]
 * @property {Function} [xRevRange]
 * @property {Function} [xrevrange]
 ...
 * @property {Function} [hset]
 * @property {Function} [hDel]
 * @property {Function} [hdel]
 * @property {Function} [lPush]
 * @property {Function} [lpush]
 * @property {Function} [rPush]
 * @property {Function} [rpush]
 * @property {Function} [lRange]
 * @property {Function} [lrange]
 * @property {Function} [lRem]
 * @property {Function} [lrem]
 * @property {Function} [lTrim]
 * @property {Function} [ltrim]
 * @property {Function} [xAutoClaim]
 * @property {Function} [xautoclaim]
