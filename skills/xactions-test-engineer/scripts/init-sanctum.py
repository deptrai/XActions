...
SKILL_ONLY_FILES = {"prompt-quality-canon.md", "memory-guidance.md", "capability-authoring.md"}
...
def main() -> int:
    ...
    print(json.dumps({"status": "complete", "sanctum": str(sanctum_path), "capabilities": len(capabilities)}))
    return 0
