...
|----------|-------------|--------------------|-----------------|-------|
| **Twitter/X** | `src/scrapers/twitter/index.js` (Puppeteer) | `src/scrapers/social/twitter/index.js` | `search(query)`, `getTimeline(username)` | Hoàn thành ở Story 13.2; profile/followers/following → 13.2.1, thread/likes/bookmarks → 13.2.2, search/hashtag/trending → 13.2.3, media → 13.2.4, lists/communities/spaces → 13.2.5, content composition/schedule → 13.2.6, engagement/social-graph → 13.2.7, DM/lists → 13.2.8, integration → 13.2.9. |
