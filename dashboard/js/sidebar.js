...
(function () {
  ...
  const icons = {
    ...
    benchmark: '<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>',
    ...
    scheduler: '<svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><polyline points="12 7 12 12 15.5 14"/></svg>',
  ...
  const navSections = [
    {
      ...
      items: [
        ...
        { href: '/scheduler', label: 'Crawl Jobs', icon: icons.scheduler },
      ]
    },
    {
