...
- `schemas/threads/social.json` (New)
- `src/scrapers/social/threads/index.js` (New)
- `src/scrapers/social/threads/client.js` (New)
- `src/scrapers/social/threads/crawler.js` (New)
- `src/scrapers/social/threads/validator.js` (New)
- `src/scrapers/social/threads/normalizer.js` (New)
- `src/scrapers/social/index.js` (Modified)
- `src/scrapers/threads/index.js` (Modified - @deprecated markers)
- `docs/deprecation-plan.md` (Modified - status tracker updated)
- `tests/scrapers/social/threads/client.test.js` (New)
- `tests/scrapers/social/threads/crawler.test.js` (New)
- `_bmad-output/implementation-artifacts/sprint-status.yaml` (Modified)
- `_bmad-output/implementation-artifacts/15-1-threads-scraper-adapter-meta-internal-graphql.md` (Modified)

### Change Log

- 2026-08-29: Implemented Story 15.1 Threads Scraper Adapter (Meta Internal GraphQL) including ThreadsClient, ThreadsCrawler, ThreadsPlatformResponseValidator, normalizer, JSON schema contract, unit/crawler tests, and deprecation markers.
